...
type value = 
  ...
  | Clos of string * expr * value env       (* (f, x, fBody, fDeclEnv), CHANGED *)
...
let rec eval (e : expr) (env : value env) : value =
    ...
    | Call(eFun, eArg) -> 
      ...
      | Clos (x, body, fDeclEnv) -> eval body ((x, (eval eArg env)) :: fDeclEnv) (* CHANGED *)
      | _ -> failwith "eval Call: not a function"
    | Fun(x, body) -> Clos (x, body, env) (* CHANGED *)
