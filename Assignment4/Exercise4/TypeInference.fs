...
let rec showType t : string =
    let rec pr t = 
        ...
        | TypL typ -> showType typ + " list" (* CHANGED *) 
...
let rec unify t1 t2 : unit =
    ...
    | TypL _, TypI ->         failwith ("type error: list and int")               (* CHANGED *) 
    | TypL _, TypB ->         failwith ("type error: list and bool")              (* CHANGED *) 
    | TypL _, TypF _ ->       failwith ("type error: list and function")          (* CHANGED *) 
    | TypL typ1, TypL typ2 -> unify typ1 typ2                                     (* CHANGED *) 
...
let rec copyType subst t : typ = 
    ...
    | TypI        -> TypI
    | TypB        -> TypB
    | TypL typ -> TypL (copyType subst typ)  (* CHANGED *)
